...
var uniqueID = "132f254e6fbd4d608feb838bd9d38415/";
    ...
    by1.addEventListener('click', async (buy) => {
        if (data.quantity >= 1) {
          ...
          try {
            ...
            {
              // axios.delete()
              await axios.delete(`https://crudcrud.com/api/132f254e6fbd4d608feb838bd9d38415/candies/${data._id}`);  
              location.reload();
            }
            else{
                await axios.put(`https://crudcrud.com/api/132f254e6fbd4d608feb838bd9d38415/candies/${data._id}`, objnew);
